...
# Modified in 2026 to port Brandon Music's v84 adapter to LIL Jovian.
...
def is_shared_expert_projection(prefix: str) -> bool:
    ...
    Brandon's v84 tree exported this helper from online.mxfp8.  The newer LIL
    vLLM removed that export, so keep the tiny path predicate local.
    """
