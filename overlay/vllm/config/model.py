...
# Modified in 2026 for EXL3 checkpoint detection on the LIL Jovian runtime.
    ...
    def _verify_quantization(self) -> None:
        ...
        if quant_cfg is not None:
            ...
            overrides = [
                ...
                "inc",
                "moe_wna16",
                # EXL3 routed-only checkpoints must be claimed before the
                # generic ModelOpt override examines their mixed source tree.
                "exl3",
                "modelopt",
                "modelopt_fp4",
                "modelopt_mxfp8",
